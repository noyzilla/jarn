...
- [ ] **Dependency Scrutiny**: No new external dependencies introduced without prior architectural agreement and documentation in `AGENTS.md`.
...
- [ ] **Companion Unit Tests**: Every creation or modification of domain logic, services, or APIs includes corresponding test cases in the same changeset. Code without test cases is incomplete.
