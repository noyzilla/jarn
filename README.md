...
- 🤖 **AI-Native Governance**: คู่มือทั้งหมด (อยู่ใน `.agents/rules/`) ถูกเขียนมาเพื่อให้ AI อ่านโดยเฉพาะ ช่วยให้ AI เข้าใจบริบทโปรเจกต์คุณได้เร็วขึ้น ลดการเดาสุ่ม และลดภาระที่คุณต้องคอยพิมพ์ Prompt สั่งซ้ำๆ
