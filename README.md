...
> **Disclaimer**: โปรเจกต์นี้เกิดจากการถอดรหัส (Extract) รูปแบบการทำงานและ Pain points ของเราเองออกมาเป็น Blueprint มันจึงมีแนวทางที่เฉพาะเจาะจงมาก (Highly Opinionated) และ **"อาจจะไม่ได้เหมาะสำหรับทุกคน"** 
> 
> หากทีมของคุณมี Workflow ที่ต่างออกไป คุณสามารถนำ Blueprint นี้ไปปรับแก้ (Fork) เพื่อใช้งานภายในทีมของคุณเองได้เลยครับ (ขอสงวนสิทธิ์ไม่รับ PR ที่พยายามเปลี่ยน Core Workflow ของที่นี่ให้เป็นรูปแบบอื่น แต่เรายินดีต้อนรับการพูดคุยแลกเปลี่ยนความรู้เรื่อง Workflow กันในหมวด Discussion ครับ!)
