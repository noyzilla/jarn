...
2. **Prefix Namespacing**: To prevent collisions with downstream project rules, all Jarn rule files MUST be prefixed with `jarn-` (e.g., `jarn-safety.md`, `jarn-workflow.md`).
