...
In accordance with the Mirror Index Pattern and documentation taxonomy in [docs/README.md](docs/README.md), detailed design system specifications follow [docs/design/0000-template.md](docs/design/0000-template.md) and are extracted into `docs/design/`:
